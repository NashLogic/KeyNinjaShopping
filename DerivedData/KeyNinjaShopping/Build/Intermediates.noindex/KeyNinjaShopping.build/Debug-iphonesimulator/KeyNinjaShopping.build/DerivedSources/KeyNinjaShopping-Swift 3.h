...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KeyNinjaShopping",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16KeyNinjaShopping11AppDelegate")
...
SWIFT_CLASS("_TtC16KeyNinjaShopping13SceneDelegate")
...
@interface ViewController (SWIFT_EXTENSION(KeyNinjaShopping)) <UITableViewDataSource, UITableViewDelegate>
